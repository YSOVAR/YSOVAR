...
class YSOVAR_atlas(astropy.table.Table):
    ...
    def calc(self, name, bands, timefilter = None, data_preprocessor = None, colnames = [], colunits=[], coldescriptions=[], overwrite = True, t_simul = None, **kwargs):
        ...
        bands : list of strings
            ...
            error (e.g. the mean error). In this case, just give tha band
            as e.g. ``36_error``.
