...
from .. import plot_atlas
from . import outroot

@pytest.mark.usefixtures("data")
class Test_plots():
    def test_lc_plots(self, data):
        plot_atlas.make_lc_plots(data, outroot, twinx = True)

    def test_cmd_plots(self, data):
        plot_atlas.make_cmd_plots(data, outroot)

    def test_ls_plots(self, data):
        plot_atlas.make_ls_plots(data, outroot, 100, 4, 1)
        
    def test_phased_plots(self, data):
        plot_atlas.make_phased_lc_cmd_plots(data, outroot)
    ...
    def test_latex(self, data):
        ...
        plot_atlas.make_latexfile(data, outroot, 'testatlas', output_cols = output_cols)
